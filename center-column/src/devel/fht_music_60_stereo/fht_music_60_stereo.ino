/*******************************************************************************
 * fht_music_60_stereo.ino - 60 LED music visualizer with FHT
 *      Author:         Ray Sun 
 ...
 *      Output      Output 1, 2         LED strip outputs 1 and 2
 *
 * Hardware:
 *      Bifrost
 *
 ...
 *      2/23/2020       Ray Sun         Rework to use Heimdall library.
 *      2/24/2020       Ray Sun         Make stereo version.
 *
 * Validation:
 *      2/24/2020       Ray Sun         Validated.
 ******************************************************************************/
...
// System constants
#define     N_LEDS              60          // Number of LEDs / pixels
...
void setup() {
    ...
    // Right
    controllers[0] = &FastLED.addLeds<NEOPIXEL, OUT1_PIN>
      (leds, N_LEDS).setCorrection( TypicalLEDStrip );
    // Left
    controllers[1] = &FastLED.addLeds<NEOPIXEL, OUT2_PIN>
      (leds, N_LEDS).setCorrection( TypicalLEDStrip );
